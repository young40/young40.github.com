...
* Update
[[http://blog.justbilt.com][bilt兄]] 看了这篇博客以后，告诉我可以将有序列的节点以数组的方式访问更有效率，我马上更新了下代码，使用起来果然更加方便了.
...
#+END_SRC
如果节点名字是`nod_text1`, `nod_text2`... 或者`img_press_1`, `img_press_2`...的节点则可以用self.nod_text[1], self.nod_text[2]来访问了
