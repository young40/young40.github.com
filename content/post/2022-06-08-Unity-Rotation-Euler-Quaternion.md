...
lastmod = 2022-07-04T15:10:13+08:00
tags = ["Unity"]
categories = ["Unity"]
draft = true
+++
...
{{< figure src="/ox-hugo/2022-06-Rotation-008.i-Rotation.png" >}}
...
-   小角度插值
    ...
    $$lerp(q\_0, q\_1, t) = (1-t)q\_0 + tq\_1\\
$$
...
\end{bmatrix} = \begin{bmatrix} cos(\frac{\theta}{2}) & sin(\frac{\theta}{2})n\_x & sin(\frac{\theta}{2})n\_y & sin(\frac{\theta}{2})n\_z
\end{bmatrix}\\
$$
